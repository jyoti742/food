<html>
  ...
  <link rel="stylesheet" href="menufetch.css">
    ...
    <img src="header.jpg" height="25%" width="100%"> 
        ...
        <h1 align="center"><font size="40" color="black">feedback</font></h1>
        <div class="row">
            ...
            <td> NAME:</td><td align="center" bgcolor=""  ><font size=3 color="black" > <b> <?php echo $row['name'];?> </b></font></td>
             ...
             <tr>
               <td>EMAIL:</td><td align="center" bgcolor=""  ><font size=3 color="black" > <b> <?php echo $row['email'];?> </b></font> </td>
                 ...
                 <tr>
               <td>SUBJECT:</td><td align="center" bgcolor=""  ><font size=3 color="black" > <b> <?php echo $row['subject'];?> </b></font> </td>
                 </tr> 
                 <tr>
                    <td>MESSAGE:</td><td align="CENTER"><font size=3 color="black" ><b> <?php echo $row['message']; ?>  </font></b></td>
                     </tr> 
