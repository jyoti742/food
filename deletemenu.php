<html>
  ...
  <link rel="stylesheet" href="menufetch.css">
    ...
    <img src="header.jpg" height="25%" width="100%"> 
        ...
        <h1 align="center"><font size="40" color="black">DELETE MENU</font></h1>
        <table width=50%>
            ...
            while($row=mysqli_fetch_assoc($result))
                 {
                    ...
                    <form action="deletemenudetails" method="post">
<tr>
 <td ><input align="CENTER"type="text"  value="<?php echo $row['id']?>" disabled></td>
 ...
 <td><button type="submit" formaction="deletemenudetails.php">delete</button></td>
</tr>
