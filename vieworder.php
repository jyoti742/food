...
<?php
  ...
  if(mysqli_num_rows($result)>0)
  {
    ...
    {?><br><br>
        ...
        <tr>
            <td> ORDER ID:</td><td align="center" bgcolor=""  ><font size=3 color="black" > <b> <?php echo $row['oid'];?> </b></font></td>
             </tr> 
             <tr>
            <td> ITEM ID:</td><td align="center" bgcolor=""  ><font size=3 color="black" > <b> <?php echo $row['menuid'];?> </b></font></td>
             </tr> 
               ...
               <td>MOBILE NO.:</td><td align="center" bgcolor=""  ><font size=3 color="black" > <b> <?php echo $row['mobile'];?> </b></font> </td>
                 ...
                 <tr>
                    <td>ADDRESS:</td><td align="CENTER"><font size=3 color="black" ><b> <?php echo $row['address']; ?>  </font></b></td>
                     ...
                     <tr>
               <td>TOTAL AMOUNT:</td><td align="center" bgcolor=""  ><font size=3 color="black" > <b> <?php echo $row['amount'];?> </b></font> </td>
                 </tr>  
